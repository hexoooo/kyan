								...
								<div class="main-content-left main-content-left-mail">
									...
									<div class="main-mail-menu">
										<nav class="nav main-nav-column mg-b-20">
											<a class="nav-link active" href=""><i class="bx bxs-inbox"></i> Inbox <span>{{$mails->count()}}</span></a> <a class="nav-link" href=""><i class="bx bx-star"></i> Starred <span>3</span></a> <a class="nav-link" href=""><i class="bx bx-bookmarks"></i> Important <span>10</span></a> <a class="nav-link" href=""><i class="bx bx-send"></i> Sent Mail <span>8</span></a> <a class="nav-link" href=""><i class="bx bx-edit"></i> Drafts <span>15</span></a> <a class="nav-link" href=""><i class="bx bx-message-error"></i> Spam <span>128</span></a> <a class="nav-link" href=""><i class="bx bx-trash"></i> Trash <span>6</span></a>
									...
									@foreach ($mails as $mail)
										...
										<div class="main-mail-body">
											...
											<div class="main-mail-subject">
												<strong>{{$mail->subject}}</strong> <span>{{$mail->message}}</span>
											</div>
										</div>
										...
										<div class="main-mail-date">
											{{date('g:i',strtotime($mail->created_at))}}
										</div>
										</div>
									@endforeach
								</div>
